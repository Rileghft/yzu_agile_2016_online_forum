...
namespace online_forum_backend
{
    ...
    class ForumDBTest
    {
        ...
        public void 插入新文章()
        {
            ...
            Assert.That(true, Is.EqualTo(db.insertArticle("teamD", "測試新文章標題", "測試摘要", "測試文章內容")));
            ...
            Assert.That(true, Is.EqualTo(db.insertArticle("teamD", "測試新文章標題2", "測試摘要2", "測試文章內容2")));
        ...
        {
            ForumDB db = new ForumDB();
            Assert.That(false, Is.EqualTo(db.insertArticle("123", "測試新文章標題", "測試摘要", "測試文章內容")));
            Assert.That(false, Is.EqualTo(db.insertArticle("test222", "測試新文章標題", "測試摘要", "測試文章內容")));
            Assert.That(false, Is.EqualTo(db.insertArticle("teamB", "測試新文章標題", "測試摘要", "測試文章內容")));
        ...
        public void 刪除文章()
        {
            ...
            db.insertArticle("teamD", "測試新文章標題3", "測試摘要3", "測試文章內容3");
        ...
        public void 插入顯示文章()
        {
            ...
            db.insertArticle("teamD", "測試新文章標題", "測試摘要", "測試文章內容");//articleID 0
            ...
            db.insertArticle("teamD", "測試新文章標題2", "測試摘要", "測試文章內容2");//articleID 1
